...
CREATE TABLE "AwardRule" (
    "id" "AwardRuleId" NOT NULL,
    "title" TEXT NOT NULL,
    "encAmount" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "user_awards_uid_event_id_key" ON "user_awards"("uid", "event_id");
